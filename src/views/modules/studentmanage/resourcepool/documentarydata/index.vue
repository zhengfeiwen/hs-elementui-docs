<template>
  <div class="documnetary_container">
    ...
    <div class="main_table">
      <hs-treetables :column="columns" @celldblclick="toDetail"></hs-treetables>
    </div>
  </div>
</template>

<script>
import hsTreetables from '@/components/Tables/Treetables'
export default {
  name: 'hs-documentary-data',
  components: {
    'hs-treetables': hsTreetables
  },
  data () {
    return {
      conditions: {
